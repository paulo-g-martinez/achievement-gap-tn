...
# extract secondry school district and unified school distrit data for merging with ach data
...
#save out
#save(unsd_2016_tn, file = "act-ach-gap/unsd_2016_tn.Rda")
...
#save out
#save(scsd_2016_tn, file = "act-ach-gap/scsd_2016_tn.Rda")
